...
public class EmployeeController {
    ...
    // If no Employee exists with the provided UUID, return a 404 Not Found status code.
    @GetMapping("/{uuid}")
    ...
    // The request body should have all necessary information to create an Employee, except for the UUID, which should
    // be generated by the Service layer.
    @PostMapping
